    ...
    <div class="flex flex-col sm:gap-4 sm:py-4 sm:pl-64">
      ...
      <main class="grid flex-1 items-start gap-4 p-4 sm:px-6 md:gap-8">
        <Card class="bg-gray-900/30 border border-indigo-700/50 text-white shadow-xl rounded-xl backdrop-blur-lg">
          <CardHeader>
            <CardTitle class="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent animate-flicker">Orders</CardTitle>
            <CardDescription class="text-gray-300 animate-glow-text">Manage your orders.</CardDescription>
          </CardHeader>
          <CardContent>
